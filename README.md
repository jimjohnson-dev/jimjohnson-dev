...
I care about the parts of the system where most failures actually occur:
**data boundaries, cross-service timing, concurrency, retries, ordering, and data aggregation.**
...
**Cloud:** AWS (Lambda, SQS, SNS, DynamoDB, Step Functions, Athena)
**Observability:** CloudWatch, OpenTelemetry
**Patterns:** Distributed systems, microservices, event-driven design
**Other:** PostgreSQL, MySQL, Docker, CI/CD (GitHub Actions)
...
* **Email:** [jmjohnson117@gmail.com](mailto:jmjohnson117@gmail.com)
